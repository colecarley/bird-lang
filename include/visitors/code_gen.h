...
public:
    ...
    void visit_decl_stmt(DeclStmt *decl_stmt)
    {
        ...
        if (decl_stmt->type_token.has_value())
        {
            ...
            if (type == BinaryenTypeInt32() && BinaryenExpressionGetType(initializer_value.value) == BinaryenTypeFloat64())
            {
                initializer_value =
                    BinaryenUnary(
                        mod,
            ...
            else if (type == BinaryenTypeFloat64() && BinaryenExpressionGetType(initializer_value.value) == BinaryenTypeInt32())
            {
                initializer_value =
                    BinaryenUnary(
                        mod,
